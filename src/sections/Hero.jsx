      ...
      <div className="section-container grid gap-12 lg:grid-cols-1 lg:items-center">
        ...
        <div className="order-2 lg:order-1 mx-auto max-w-3xl space-y-8 text-center">
          ...
          >
            ...
            <a
              className="ml-0 inline-flex group items-center justify-center rounded-full border border-brand-dark/20 px-6 py-3 text-sm font-medium text-brand-dark hover:bg-brand-dark/5 transition-all"
              href="#services"
            >
              Our Services
